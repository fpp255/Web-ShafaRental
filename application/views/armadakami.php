        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header-info">
                    ...
                    <p>Semua jenis mobil rental ada di PT Shafa Anugerah Trans <br>Proses cepat dan mudah</p>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-lg-4 col-md-6 padding-15">
                            <div class="pricing-item">
                                ...
                                <ul class="pricing-list">
                                    ...
                                    <li><a href="https://api.whatsapp.com/send?phone=6281292515737&text=Saya ingin order rental mobil <?php echo $mobil->nama_jmobil; ?>" class="default-btn" target="_blank"><i class="la la-whatsapp la-lg"></i>&nbsp;Pesan Sekarang</a></li>
                                </ul>
                            </div>
                        </div>
                    <?php } ?>
