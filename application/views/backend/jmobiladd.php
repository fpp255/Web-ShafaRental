							...
							<?php } ?>	
			      			<div class="box box-info">
					            ...
					            <div class="box-body">
					              	<div class="row">
					                	<div class="col-md-12">
					                  		<form id="form1" name="form1" action="<?php echo site_url('/backend/jmobil/add')?>" method="post" enctype="multipart/form-data">
												<div class="row">
		      										<div class="col-md-12">
		      											<div class="form-group">
															<label <?php if (form_error('namajmobil')) {echo "style='color:#f56954'";} ?> />Nama Jenis Mobil:</label>
															<input type="text" name='namajmobil' value="<?php echo set_value('namajmobil')?>" class="form-control" <?php if (form_error('namajmobil')) {echo "style='border-color:#f56954'";} ?> />
														</div>
		      										</div>
		      									</div>
