...
<html class="no-js" lang="en">
    <head>
        ...
        <meta name="description" content="Shafa Rental Mobil">
        
        <title>Shafa Rental Mobil</title>

        <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/frontend/img/favicon.png">
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/keyframe-animation.css">
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/venobox.min.css">
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/slider.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/blog.css">
    ...
    <body>
            ...
            <div class="mid-header">
                <div class="container">
                    <div class="mid-header-wrap">
                        <div class="site-logo">
                            <a href="index.html"><img src="<?php echo base_url(); ?>assets/frontend/img/logo-dark.png" alt="Logo"></a>
                        </div><!--/.site-logo-->
        ...
        <div id="popup-sidebox" class="popup-sidebox">
            <div class="sidebox-content">
                <div class="site-logo">
                    <a href="index.html"><img src="<?php echo base_url(); ?>assets/frontend/img/logo-light.png" alt="logo"></a>
                </div>
            ...
            <div class="main-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slider-img"><img src="<?php echo base_url(); ?>assets/frontend/img/slider-bg.jpg" alt="img" class="kenburns"
                                style="animation-duration: 12000ms; "></div>
                        <div class="car-holder">
                            <img src="<?php echo base_url(); ?>assets/frontend/img/car-1.png" alt="car" data-animation="car-animation" data-duration="1.5s">
                            <div class="shape">
        ...
        <section class="about-section padding">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="about-img">
                            <img class="about-img1 wow fade-in-left" data-wow-delay="200ms" src="<?php echo base_url(); ?>assets/frontend/img/about-1.png" alt="img">
                            <img class="about-img2 wow fade-in-bottom" data-wow-delay="400ms" src="<?php echo base_url(); ?>assets/frontend/img/about-2.png" alt="img">
                            <figure class="round-text"><img src="<?php echo base_url(); ?>assets/frontend/img/experience-text-round.png" alt="img"></figure>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <ul class="about-info wow fade-in-right" data-wow-delay="400ms">
                            <li>
                                <img class="owner-thumb" src="<?php echo base_url(); ?>assets/frontend/img/comment-1.png" alt="thumb">
                                <div class="owner">
                                    <h4>Founder - CEO</h4>
                                    <img class="signature" src="<?php echo base_url(); ?>assets/frontend/img/signature.png" alt="signature">
                                </div>
                            </li>
                            <li>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="service-item wow fade-in-bottom" data-wow-delay="200ms">
                                    <div class="service-thumb">
                                        <img src="<?php echo base_url(); ?>assets/frontend/img/service-1.jpg" alt="img">
                                        <div class="service-shape-wrap">
                                            <div class="service-shape"></div>
                                        </div>
                                        <div class="service-car"><img src="<?php echo base_url(); ?>assets/frontend/img/car-1.png" alt="car"></div>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="service-item wow fade-in-bottom" data-wow-delay="400ms">
                                    <div class="service-thumb">
                                        <img src="<?php echo base_url(); ?>assets/frontend/img/service-2.jpg" alt="img">
                                        <div class="service-shape-wrap">
                                            <div class="service-shape"></div>
                                        </div>
                                        <div class="service-car"><img src="<?php echo base_url(); ?>assets/frontend/img/car-1.png" alt="car"></div>
                            ...
                            <div class="swiper-slide">
                                <div class="service-item wow fade-in-bottom" data-wow-delay="600ms">
                                    <div class="service-thumb">
                                        <img src="<?php echo base_url(); ?>assets/frontend/img/service-3.jpg" alt="img">
                                        <div class="service-shape-wrap">
                                            <div class="service-shape"></div>
                                        </div>
                                        <div class="service-car"><img src="<?php echo base_url(); ?>assets/frontend/img/car-1.png" alt="car"></div>
                            ...
                            <div class="swiper-slide">
                                <div class="service-item">
                                    <div class="service-thumb">
                                        <img src="<?php echo base_url(); ?>assets/frontend/img/service-4.jpg" alt="img">
                                        <div class="service-shape-wrap">
                                            <div class="service-shape"></div>
                                        </div>
                                        <div class="service-car"><img src="<?php echo base_url(); ?>assets/frontend/img/car-1.png" alt="car"></div>
                            ...
                            <div class="swiper-slide">
                                <div class="service-item">
                                    <div class="service-thumb">
                                        <img src="<?php echo base_url(); ?>assets/frontend/img/service-5.jpg" alt="img">
                                        <div class="service-shape-wrap">
                                            <div class="service-shape"></div>
                                        </div>
                                        <div class="service-car"><img src="<?php echo base_url(); ?>assets/frontend/img/car-1.png" alt="car"></div>
                                ...
                                <div class="pricing-item">
                                    <div class="pricing-head-wrap">
                                        <div class="pricing-car">
                                            <img src="<?php echo base_url(); ?>assets/frontend/img/pricing-car.png" alt="car">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section-heading wow fade-in-left" data-wow-delay="200ms">
                            ...
                            <ul class="app-feature">
                                <li>
                                    <i><img class="feature-icon" src="<?php echo base_url(); ?>assets/frontend/img/icon-navigator.svg" alt="icon"></i>
                                    <h3>Easy to Search <br> Ridek Taxi!</h3>
                                </li>
                                <li>
                                    <i><img class="feature-icon" src="<?php echo base_url(); ?>assets/frontend/img/icon-clock.svg" alt="icon"></i>
                                    <h3>Quick Pickups To <br> Save Time!</h3>
                                </li>
                                <li>
                                    <i><img class="feature-icon" src="<?php echo base_url(); ?>assets/frontend/img/icon-docs.svg" alt="icon"></i>
                                    <h3>Inclusive Rates To<br> Enjoy Ride!</h3>
                                </li>
                            </ul>
                            <div class="download-btn">
                                <a href="#"><img src="<?php echo base_url(); ?>assets/frontend/img/google-play.svg" alt="PlayStore"></a>
                                <a href="#"><img src="<?php echo base_url(); ?>assets/frontend/img/app-store.svg" alt="AppStore"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="taxi-holder">
                            ...
                            <img class="location-marker" src="<?php echo base_url(); ?>assets/frontend/img/location-marker.png" alt="location">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testi-item">
                                            ...
                                            <div class="testi-author">
                                                <div class="author-thumb"><img src="<?php echo base_url(); ?>assets/frontend/img/comment-1.png" alt="author">
                                                </div>
            ...
            <div class="container">
                ...
                <div class="row grid-post">
                    <div class="col-lg-4 col-md-6 padding-15">
                        <div class="post-card">
                            <div class="post-thumb">
                                <img src="<?php echo base_url(); ?>assets/frontend/img/post-1.jpg" alt="post">
                    ...
                    <div class="col-lg-4 col-md-6 padding-15">
                        <div class="post-card">
                            <div class="post-thumb">
                                <img src="<?php echo base_url(); ?>assets/frontend/img/post-2.jpg" alt="post">
                    ...
                    <div class="col-lg-4 col-md-6 padding-15">
                        <div class="post-card">
                            <div class="post-thumb">
                                <img src="<?php echo base_url(); ?>assets/frontend/img/post-3.jpg" alt="post">
                ...
                <div class="container">
                    <div class="footer-top">
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="brand">
                                    <a class="footer-logo" href="index.html"><img src="<?php echo base_url(); ?>assets/frontend/img/logo-light.png" alt="logo"></a>
        ...
        <!--jQuery Lib-->
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/jquary-3.6.0.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/jquery.ajaxchimp.min.js"></script>
        ...
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/swiper.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/jquery.datetimepicker.full.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/jquery.nice-select.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/venobox.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/smooth-scroll.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/wow.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/frontend/js/book-ride.js"></script>
